...
### 📄 The Cold Email Copy Swipe File
...
### 📕 The Outbound Implementation Guide

**[Open the guide →](https://claude.ai/public/artifacts/d403a11f-86b5-42d3-b1d1-ba87f84b4e0f)**

A 78-page reference document, in 25 sections. This is the thing to keep open in a second
tab while you build.

| Section | Covers |
| --- | --- |
| ICP framework | Building a target list that doesn't waste sends |
| Deliverability | Every rule for domains, mailboxes and warm-up, so nothing burns |
| Offer & copy | The complete copywriting rules, step by step |
...
**Where it fits:** Phase 2, before you touch copy.
...
**Where it fits:** Phase 3, after the ICP exists.

### 🗺️ The Implementation Map
...
A 98-minute training on running LinkedIn alongside your email campaign, on the same list.

The logic: you've already done the work to find these contacts, and LinkedIn is a second
channel to the same people at no additional sourcing cost. Covers connection and message
sequencing that doesn't look automated, safe daily limits, and the account-safety rules
that keep it running long-term.

**Where it fits:** after your email campaign is live, not before.
...
| Resource | URL |
| --- | --- |
| Cold Email Copy Swipe File | https://navy-professor-355.notion.site/Best-Performing-Email-Copy-Examples-1cd26bb2645a46cab8e5cd970ef04259 |
| Outbound Implementation Guide | https://claude.ai/public/artifacts/d403a11f-86b5-42d3-b1d1-ba87f84b4e0f |
| Community | https://chat.whatsapp.com/L3ht1NZZvqqEEBlT3XML0b |
| Full training | https://course.intentledsales.com |
